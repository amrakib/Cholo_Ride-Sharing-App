...
{
    $notleaveableFlag=True;
}
else if ($data[0]["trip_status"]=="Finished")
{
    $finishedFlag=False;
}
?>
...
?>
        <div class="d-flex d-flex justify-content-center  flex-row mt-3 ">
        <button type="Submit" id="myButton" class="btn btn-outline-danger ">Trip Ongoing. Cannot Leave</button>
        <script>
...
?>
        <div class="d-flex d-flex justify-content-center  flex-row mt-3 ">
        <button type="Submit" id="myButton" class="btn btn-outline-danger ">Trip Finished. Mark as Reached</button>
        </a>
        </div>
        </form>
